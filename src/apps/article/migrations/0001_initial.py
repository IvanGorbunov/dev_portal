    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('on_approval', 'On approval'), ('rejected', 'Rejected'), ('agreed', 'Agreed'), ('published', 'Published'), ('on_revision', 'On revision'), ('on_actualization', 'On actualisation')], default='draft', max_length=30, verbose_name='Status')),
